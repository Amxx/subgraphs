...
function governorType(address: Address): string | null {
	...
	if (!call.reverted && call.value.toHex() == "0x8e25870c07e0b0b3884c78da52790939a455c275406c44ae8b434b692fb916ee") { return 'ALPHA' } // keccak256("Ballot(uint256 proposalId,bool support)");
	if (!call.reverted && call.value.toHex() == "0x150214d74d59b7d1e90c73fc22ef3d991dd0a76b046543d4d80ab92d2a50328f") { return 'BRAVO' } // keccak256("Ballot(uint256 proposalId,uint8 support)");
	return 'UNKNOWN'
}
